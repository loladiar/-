...
```bash
for e in prep-comm-text stop-comm-text prep-corpus resplit pp-w,z pp-z,d tame-hadoop tame-corpus tame-topics tame-topics-l p-topics p-topics.rb vectors.rb exam-comm-text; do
